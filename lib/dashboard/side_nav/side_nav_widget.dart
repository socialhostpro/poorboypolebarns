                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIDE_NAV_COMP_Text_dopywkvx_ON_TAP');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIDE_NAV_COMP_Text_wlnn1ij0_ON_TAP');
                                          logFirebaseEvent('Text_navigate_to');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIDE_NAV_COMP_Text_kqmihjov_ON_TAP');
                                          logFirebaseEvent('Text_navigate_to');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIDE_NAV_COMP_Text_f0gj8yqt_ON_TAP');
                                          logFirebaseEvent('Text_navigate_to');
                        ...
                        child: Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SIDE_NAV_ADD_EDIT_GALLERY_BTN_ON_TAP');
                                logFirebaseEvent('Button_navigate_to');

                                context.pushNamed('GallerySettings');
                              },
                              text: FFLocalizations.of(context).getText(
                                'grf2zc6x' /* Add / Edit Gallery */,
                              ),
                              icon: const FaIcon(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'SIDE_NAV_COMP_Icon_rj3pbhfk_ON_TAP');
